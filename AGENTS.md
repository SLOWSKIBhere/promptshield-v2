...
- Run relevant tests after changes. Run production builds when frontend or backend build behavior may be affected, and report every failure rather than silently ignoring it.
